            ...
            if(isset($_GET['p_id'])){
                ...
                $select_all_posts_query = mysqli_query($connection, $query);
                 ...
                 if(mysqli_num_rows($select_all_posts_query) < 1){
                    ...
                    echo "<p class='alert alert-info'> No posts available </p>";
                }else{ 
                       ...
                       ?>
                        ...
                        session_start();
                            if(isset($_SESSION['user_role']) && $_SESSION['user_role'] === 'admin'){
                                 if(isset($_GET['p_id'])){
                                    $the_post_id = $_GET['p_id'];
                                    echo "<a class='btn btn-success'href='admin/posts.php?source=edit_post&p_id={$the_post_id}'>Edit post</a>";
                            }}}
                            ?>
                            ...
                            <hr>
                            <p><?php echo $post_title ?><?php echo $post_content ?></p>
                ...
                <!--Comments Post here -->
                    ...
                    <form action="" method="post" role="form">
                     ...
                     <label for="Author">Author</label>
                        ...
                        <div class="form-group">
                        <label for="comment">Comment text here</label>
