...
if(isset($_POST['edit_user'])){
	...
	// $selec_rand_salt_query = mysqli_query($connection, $query);
	// if(!$selec_rand_salt_query){
	// 	die("Ne radi" . mysqli_error($connection));
	
	// $row = mysqli_fetch_array($selec_rand_salt_query);
	// $salt = $row['randSalt'];
