...
if(isset($_POST['checkBoxArray'])){
    ...
    case 'clone':
            ...
            if(!$copy_query){
                die("Neuspjesan upit" . mysqli_error($connection));
            }
...
<div id="bulkOptionContainer" class="pull-left">
...
<tbody>
    ...
    // echo "<td><a onClick=\"javascript: return confirm('Delete This Post?'); \"href='posts.php?delete={$post_id}'>Delete</a></td>";
    echo "<td><a rel='$post_id' href='javascript:void(0)' class='delete_link'>Delete</a></td>";
    echo "<td><a href='post_comments.php?reset={$post_id}'>{$post_views_count}</td></a>";
    echo "</tr>";
